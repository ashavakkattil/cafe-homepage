<template>
  <div>
    <div>
      <div class="text-h3 text-center q-my-xl text-weight-bold">Instagram Gallery</div>
      <div class="text-center">
        <p class="q-mb-xs">Share your memories on Instagram by tagging us @Loren's Cafe</p>
      ...
      <div class="text-center q-my-lg">
        <q-btn color="primary" size="xl">Follow us on instagram</q-btn>
      </div>
    </div>
  </div>
</template>
